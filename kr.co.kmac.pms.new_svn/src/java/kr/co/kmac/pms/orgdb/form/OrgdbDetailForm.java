/*
 * $Id: OrgdbDetailForm.java,v 1.1 2009/09/19 11:15:44 cvs3 Exp $
 * created by    : jiwoongLee
 * creation-date : May 21, 2008
 * =========================================================
 * Copyright (c) 2008 ManInSoft, Inc. All rights reserved.
 */
package kr.co.kmac.pms.orgdb.form;

import kr.co.kmac.pms.attach.form.AttachForm;


/**
 * @struts:form name="orgdbActionForm"
 */
public class OrgdbDetailForm //extends ActionForm  
extends AttachForm 
{

	//static final long serialVersionUID = -7034897190725766229L;
	...
	/**
	 * @return Returns the contactWork.
	 */
	...
	/**
	 * @param contactWork The contactWork to set.
	 */
	...
	/**
	 * @param creatorSsn The creatorSsn to set.
	 */
