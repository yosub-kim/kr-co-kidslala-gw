...
public class EstimateData {	
	...
	private String estimateP;
	private String estimateC;
	 ...
	 */
	public String getEstimateP() {
		return estimateP;
	}
	/**
	 * @param average The average to set.
	 */
	public void setEstimateP(String average) {
		this.estimateP = average;
	}
	/**
	 * @return Returns the averageC.
	 */
	public String getEstimateC() {
		return estimateC;
	}
	/**
	 * @param averageC The averageC to set.
	 */
	public void setEstimateC(String averageC) {
		this.estimateC = averageC;
	}
	/**
