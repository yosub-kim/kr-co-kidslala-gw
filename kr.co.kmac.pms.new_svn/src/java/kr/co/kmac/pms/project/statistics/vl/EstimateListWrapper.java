...
import kr.co.kmac.pms.project.statistics.data.EstimateData;
...
public class EstimateListWrapper implements ObjectWrapper {
	...
	public Object getWrappedRecord(Object objectToBeWrapped) {
		...
		try {
			...
			try{estimateData.setAnswer1(rs.getString("answer1"));}catch(Exception e){}
			try{estimateData.setAnswer2(rs.getString("answer2"));}catch(Exception e){}
			...
			throw exceptionTranslator.translate("EstimateListWrapper fails",null,e);
		}
	}
