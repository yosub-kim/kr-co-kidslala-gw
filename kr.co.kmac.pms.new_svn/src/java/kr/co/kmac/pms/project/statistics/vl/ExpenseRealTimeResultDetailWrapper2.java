...
public class ExpenseRealTimeResultDetailWrapper2 implements ObjectWrapper {
	...
	public Object getWrappedRecord(Object arg0) {
		...
		try {
			...
			expenseRealTimeResult.setAmount(rs.getString("amount"));
			expenseRealTimeResult.setAmount2(rs.getString("amount2"));
			...
			throw exceptionTranslator.translate("ExpenseRealTimeResultWrapper2 fails", null, e);
		}
	}
