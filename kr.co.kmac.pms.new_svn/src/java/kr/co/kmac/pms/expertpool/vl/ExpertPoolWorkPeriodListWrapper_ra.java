...
public class ExpertPoolWorkPeriodListWrapper_ra implements ObjectWrapper {
	...
	public Object getWrappedRecord(Object objectToBeWrapped) {
		...
		try {
			...
			expertPool.setMm(rs.getString("mm"));
			expertPool.setAddOccur2(rs.getString("addoccur2"));
			expertPool.setJointUse(rs.getString("jointUse"));
			...
			throw exceptionTranslator.translate("ExpertPoolWorkPeriodListWrapper_ra fails", null, e);
		}
		return expertPool;
	}
