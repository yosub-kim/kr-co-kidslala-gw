...
public class ExpertPoolWorkPeriodListWrapper_workDay implements ObjectWrapper {
	...
	public Object getWrappedRecord(Object objectToBeWrapped) {
		...
		try {
			...
			throw exceptionTranslator.translate("ExpertPoolWorkPeriodListWrapper_workDay fails", null, e);
		}
		return expertPool;
	}
