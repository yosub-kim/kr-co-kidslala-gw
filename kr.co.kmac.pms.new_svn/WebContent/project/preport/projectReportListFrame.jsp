...
<body leftmargin="15" topmargin="0" style="overflow-x:hidden;overflow-y:hidden">
   ...
   <iframe id="preport" 
     src="/action/ProjectReportInfoAction.do?mode=getProjectReportInfoList&projectCode=<%= request.getParameter("projectCode") %>&viewMode=<%= request.getParameter("viewMode") %>"
