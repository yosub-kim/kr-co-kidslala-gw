...
<body>
   ...
   <iframe id="attach" src="/action/ProjectExpenseAction.do?mode=projectExpenseHistoryDetail&projectCode=<%= request.getParameter("projectCode") %>&viewMode=<%= request.getParameter("viewMode") %>
