...
function goPage(next_page) {
	...
	document.form.target = "";		
	document.form.action = "/action/ProjectExpenseAction.do?mode=realTimeProjectExpenseManagement2";
	document.form.submit();
}
function doSearch() {
...
function goHistoryPage2() {
	...
	document.form.year.value = year;
	document.form.month.value = month;
	document.form.action = "/action/ProjectExpenseAction.do?mode=projectExpenseHistoryManagement2_20";
	document.form.submit();
	return;	
}
...
<%
	...
	headerRow.addCell(new Cell("예상 성과급 합계").setAttribute(" style='padding: 7px 1px 7px 1px' width='15%' "));
	...
	headerRow.addCell(new Cell("예상 성과급").setAttribute(" style='padding: 7px 1px 7px 1px' width='15%' "));
...
<%
	...
	headerRow2.addCell(new Cell("예상 성과급 합계").setAttribute(" style='padding: 7px 1px 7px 1px' width='15%' "));
	/* headerRow.addCell(new Cell("지도율").setAttribute(" style='padding: 7px 1px 7px 1px' width='10%' ")); */
	headerRow2.addCell(new Cell("프로젝트명").setAttribute(" style='padding: 7px 1px 7px 1px' width='32%' "));
	headerRow2.addCell(new Cell("예상 성과급").setAttribute(" style='padding: 7px 1px 7px 1px' width='15%' "));
	...
	if(list2 != null && list2.size() > 0){
		for(ExpenseRealTimeResult realTimeResult : list2){
			...
			row2.addCell(new Cell(StringUtil.longt2Money(realTimeResult.getSalarySum2())).setAttribute(" align='right' style='cursor:hand;' "));
			/* row.addCell(new Cell(realTimeResult.getInvolvedPrjCnt()).setAttribute(" align='center' style='cursor:hand;'   ")); */
...
<body>
	<form name="form" method="post">
		...
		<table width="100%" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td>
					<h3 class="mainTitle"><c:out value="${year}" />년  <c:out value="${month}" />월 컨설턴트별 실시간 성과급</h3>
				</td>
			</tr>
						...
						<tr>
							<td height="35">
								...
								<h4 class="subTitle mt15 mb5">2) 실시간 20%  성과급 </h4>
									...
									<div class="btNrighTdiv">
										<a class="btNa0a0a0 txt4btn" href="javascript:goHistoryPage2()">이전 성과급 내역 보기</a>
									</div>
									</br>
								</div>
							</td>
