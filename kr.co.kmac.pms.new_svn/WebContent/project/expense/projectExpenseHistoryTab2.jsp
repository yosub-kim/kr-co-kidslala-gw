...
<body>
	<div class="location">
		<p class="menu_title">성과급 관리(보직자)</p>
		<ul>
	...
	<div class="contents sub">
		...
		<div class="fixed_box">
			<div class="title">
				<div class="h1_area">
					<p class="h1">
						<i class="mdi mdi-file-document-outline"></i>실시간 성과급 관리
					</p>
				</div>
				<div class="btn_area">
			...
			<div class="fixed_contents sc">
				<div class="tab_menu_area">
					<ul id="tab_menu" class="tab_ui">		
						<li class="current"><a href="#" class="active"	id="pane1">본부/센터별 성과급</a></li>
					...
					<script type="text/javascript">
						...
						{
							'pane1': '/project/expense/projectExpenseHistoryFrame2_coo.jsp'
							,'pane2': '/project/expense/projectExpenseHistoryFrame_coo.jsp'
						},
						{
							onClick: function(e) {
