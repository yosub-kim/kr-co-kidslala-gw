				...
				function selectHandler() {
					...
					for (var i = 0; i < selection.length; i++) {
						...
						if (item.row != null && item.column != null) {
							if(item.row == 0){bizTypeCode = 'BTA';}
							else if(item.row == 1){bizTypeCode = 'BTB';}
							else if(item.row == 2){bizTypeCode = 'BTC';}
							else if(item.row == 3){bizTypeCode = 'BTJ';}
							else if(item.row == 4){bizTypeCode = 'BTD';}
							else if(item.row == 5){bizTypeCode = 'BTE';}
							else if(item.row == 6){bizTypeCode = 'BTF';}
