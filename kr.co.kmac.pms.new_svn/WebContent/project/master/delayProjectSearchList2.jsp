			...
			<tr>
				<td height="12">
					...
					<jsp:include page="/common/include/includePageMainTitle.jsp" flush="true">
						<jsp:param name="title" value="지연 프로젝트 현황(예정)" />
...
귀하의 담당 프로젝트에 일정 지연이 발생 할 예정이오니 신속한 조치 바랍니다.
- KMAC 경영기획실 -</textarea>
					</c:when>
					<c:when test="${projectState eq '4' }">
					<textarea style="width: 100%; height: 150px;" name="smsMessage" id="smsMessage">안녕하십니까, 
귀하의 담당 프로젝트에 평가 지연이 발생 할 예정이오니 신속한 조치 바랍니다.
- KMAC 경영기획실 -</textarea>
					</c:when>
					<c:when test="${projectState eq '5' }">
					<textarea style="width: 100%; height: 150px;" name="smsMessage" id="smsMessage">안녕하십니까, 
귀하의 담당 프로젝트에 리뷰 지연이 발생 할 예정이오니 신속한 조치 바랍니다.
- KMAC 경영기획실 -</textarea>
					</c:when>
				</c:choose>				
			</td>
