...
//var j$ = jQuery;
	...
	j$(document).ready(function(){
		...
		function createStatusbar(obj){
			...
			var appendStr = "<div class='file_text_area' style='padding:0 0 2 50'>";
			appendStr += "	 	<div class='file_text'>[NEW]<p><a href='#'><input type='text' name='attachFileName' style='width:100%;' readonly></a></p> ";
			...
			<c:if test="${fileMode == 'WRITE'}">
				<c:if test="${!empty fileList}">
					<c:forEach var="file" items="${fileList}">
						<div class="file_text_area" style="padding: 0 0 0 50">
							...
							<c:choose>
								...
								<c:otherwise>
									...
									<!-- file info add -->
									<div class="file_text">
										[파일]<p><a href="#" onclick="fileDownload1('<c:out value="${file.attachFileId}"/>')">
