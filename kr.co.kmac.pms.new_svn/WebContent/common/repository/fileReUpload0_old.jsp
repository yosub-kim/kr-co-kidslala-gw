...
<script type="text/javascript">
	function addRowAttachFile0(targetTblObjId){
	    var tableObj;
	    if (targetTblObjId != undefined && targetTblObjId != "")
	    	tableObj = $(targetTblObjId); 
	    else
	    	tableObj = $('attachFileTable0');
		...
		newCellArr[1].innerHTML = "<select name='attachIsEssential' class='selectbox'><option value='0' <c:out value="${preportEssentialFlag}"/> >비필수</option><option value='1'>필수</option></select>";
