...
function doSearch() {
	...
	document.frm.target = "";
	document.frm.action = "/action/AccessLogAction.do?mode=getLoginLogReport";
	document.frm.submit();
}
	...
	<tr>
		<td height="12">
			...
			<jsp:include page="/common/include/includePageMainTitle.jsp" flush="true">
				<jsp:param name="title" value="로그인 현황(이름 순)" />
		...
		<td height="35px">
			...
			<div class="btNbox pb15">
				...
				<div class="btNrighTdiv">
					<a class="btNa0a0a0 txt2btn" href="/action/AccessLogAction.do?mode=getLoginLogTimeOrderReport">접속 시간 순으로 현황 보기</a>
				</div>
			</div>
		</td>
	</tr>
				...
				<tbody id="ListData">
					<c:choose>
						<c:when test="${!empty list.list}">
							...
							<tr onmouseover="row_over(this);" onmouseout="row_out(this);" style="cursor: hand;" onclick="go_detail('<c:out value="${result.ssn}"/>','<c:out value="${result.name}"/>');">
