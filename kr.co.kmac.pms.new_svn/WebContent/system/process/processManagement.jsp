		...
		<tr>
			<td height="12">
				<jsp:include page="/common/include/includePageMainTitle.jsp" flush="true">
					<jsp:param name="title" value="프로세스 관리" />
				</jsp:include>
			</td>
		</tr>
<!-- 본문시작-->
		...
		<tr>
			<td>
				<div class="tabbed-pane">
					<ol class="tabs">
						<li><a href="#" class="active" 	id="pane1">상품 및 프로세스 분류 관리</a></li>
						<li><a href="#"					id="pane2">프로세스 템플릿 관리</a></li>
					</ol>
					...
					<script type="text/javascript">
						new TabbedPane('Process', 
							{
								'pane1': '/action/ProcessCategoryAction.do?mode=getProcessCategoryList',
								'pane2': '/action/ProcessTemplateAction.do?mode=getProcessTemplateList'
							},
							{
								onClick: function(e) {
