                ...
                <div class="tbl-wrap">
                    <table class="tbl list common"><!-- 공통으로 사용할 리스트 페이지 .common -->						
                        <tbody>
                            <tr>
                                <td>
                                    <a href="/action/MobileBoardAction.do?mode=selectList&bbsId=publicNotice">
                                        <div>
                                            <div>
                                                <div class="title"><p><i class="mdi mdi-message-text"></i>공지사항</p></div>
                                            </div>
                            ...
                            <tr>
                                <td>
                                    <a href="/action/MobileBoardAction.do?mode=selectList&bbsId=sharebbs">
                                        <div>
                                            <div>
                                                <div class="title"><p><i class="mdi mdi-message-text"></i>열린세상</p></div>
                                            </div>
                                            <button type="button"><i class="mdi mdi-arrow-right-circle"></i></button>
                                        </div>
                                    </a>
