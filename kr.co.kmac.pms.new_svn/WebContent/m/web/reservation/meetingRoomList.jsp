...
<body> 
<div data-role="page" id="meetingRoomListPage">
	<input type="hidden" id="reservationGubun" value="C">
	...
	<div data-role="content">
		<div class="ui-grid-solo" style="text-align: center; ">
			<ul data-role="listview" id="meetingRoomListSelectorView">
		...
		<div class="ui-grid-solo" style="text-align: center; ">
			<ul data-role="listview" id="meetingRoomListView">
				<li data-role="list-divider">회의실 선택</li>
			</ul>
		</div> 
	</div><!-- /content -->
