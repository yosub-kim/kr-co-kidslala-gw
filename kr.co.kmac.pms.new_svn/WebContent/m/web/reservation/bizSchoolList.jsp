...
<body> 
<div data-role="page" id="bizSchoolListPage">
	<div data-role="header" data-theme="a"> 
		<h1 onclick="goHOME();">KMAC 인트라넷</h1>
		<a href="/m/web/reservation/bizSchoolIndex.jsp" data-icon="arrow-l" data-iconpos="notext">back</a>
		<a href="javascript:goInsertBizSchoolReservation();" data-icon="gear">등록</a>
	</div><!-- /header -->

	<div data-role="content">
		<div class="ui-grid-solo" style="text-align: center; ">
			<ul data-role="listview" id="bizSchoolListSelectorView">
				<li data-role="list-divider">예약일자 선택</li>
				<li style="height: 60px; padding: 0px; margin-bottom: 10px;">
					<table style="width: 100%;">
						<tr>
							<td>
								<select name="selYear" id="selYear" onchange="getBizSchoolListPageSearch()">
							...
							<td>
								<select name="selMonth" id="selMonth" onchange="getBizSchoolListPageSearch()">
							...
							<td>
								<select name="selDay" id="selDay" onchange="getBizSchoolListPageSearch()">
		...
		<div class="ui-grid-solo" style="text-align: center; ">
			<ul data-role="listview" id="bizSchoolListView">
				<li data-role="list-divider">강의실 선택</li>
			</ul>
		</div> 
	</div><!-- /content -->
